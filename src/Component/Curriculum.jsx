    ...
    <>
      <section id="about" className="CvSection" Section>
        ...
        <p>
          ...
          audiences. I have worked on animation and 3D modeling projects for the
          entertainment and advertising indusdivies, as well as on user
          interface design and website development for companies. I am
          passionate about digital art and new technologies, which drives me to
          constantly stay updated and seek new opportunities for professional
          growth.
        </p>
      </section>
